...
<html>
	<body>
		<?php 
			...
			//function to clean any output before it is sent - converts any HTML chars into text, including and quote marks. also removes whitespace before and after input
